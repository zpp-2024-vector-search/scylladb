...
@pytest.mark.skip(reason="The Python driver doesn't support variable width types in vectors yet")
...
# Test commented out because Scylla doesn't support token(*literal*) syntax.
