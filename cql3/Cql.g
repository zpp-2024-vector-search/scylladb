...
vector_type [bool internal] returns [shared_ptr<cql3::cql3_type::raw> pt]
    : K_VECTOR '<' t=comparator_type[internal] ',' d=INTEGER '>'
        { if (t) { $pt = cql3::cql3_type::raw::vector(t, std::stoul($d.text)); } }
    ;
